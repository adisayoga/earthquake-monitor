...
/**
 * Template email saat mengirim pesan secara otomatis.
 * 
 * @author Adi Sayoga
 */
public class MailTemplateActivity extends Activity {
	...
	private void bindView() {
		...
		templateText.setText(prefs.getMailTemplate(this));
		detailText = (EditText) findViewById(R.id.detail_text);
		detailText.setText(prefs.getMailTemplateDetail(this));
	}
	...
	private void saveSettings() {
		prefs.setMailTemplate(templateText.getText().toString());
		prefs.setMailTemplateDetail(detailText.getText().toString());
	}
